        ...
        UIView.animate(withDuration: 0.25, animations: { [unowned self] in
            ...
            */
            ...
            self.view.layoutIfNeeded()
                ...
                this.bottomView.removeFromSuperview()
                
                // Update instance variables.
                this.bottomView = this.topView
                this.topView = entering
                this.spaceBetweenViewsConstraints = newSpaceBetweenViews
                
                // Schedule the next update.
                Timer.scheduledTimer(timeInterval: 1.0, target: this, selector: #selector(this.updateViews(timer:)), userInfo: nil, repeats: false)
        })
    }
